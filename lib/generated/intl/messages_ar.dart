...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m0(email) =>
      "لقد أرسلنا رابط إعادة تعيين إلى ${email}. أدخل الرمز المكون من 6 أرقام المذكور في البريد الإلكتروني.";

  final messages = _notInlinedMessages(_notInlinedMessages);
  static Map<String, Function> _notInlinedMessages(_) => <String, Function>{
    "Bus": MessageLookupByLibrary.simpleMessage("حافلة"),
    "Hiace": MessageLookupByLibrary.simpleMessage("هايس"),
    ...
    "forgotPasswordMessage": MessageLookupByLibrary.simpleMessage(
      "يرجى إدخال بريدك الإلكتروني أو رقم هاتفك لإعادة تعيين كلمة المرور.",
    ),
    ...
    "orLoginWith": MessageLookupByLibrary.simpleMessage("أو سجل الدخول عبر"),
    "otp_verification": MessageLookupByLibrary.simpleMessage("التحقق من OTP"),
